...
:: Android packaging
set AND_CERT_NAME="OpenVideo"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\OpenVideo.p12
...
set IOS_PROVISION=cert\OpenVideo.mobileprovision
...
set APP_ID=air.OpenVideo

:: Output packages
set DIST_PATH=dist
set DIST_NAME=OpenVideo
